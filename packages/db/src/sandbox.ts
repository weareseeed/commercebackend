...
export async function resetAndSeedSandbox(): Promise<SandboxSeedResult> {
  ...
  const sellerAgent = await prisma.agent.create({
    data: {
      ...
      apiKeySalt: sellerKeys.apiKeySalt,
      apiKeyId: sellerKeys.apiKeyId,
      status: 'active',
      createdAt: fixedNow,
      updatedAt: fixedNow,
    },
  ...
  const autoBuyerAgent = await prisma.agent.create({
    data: {
      ...
      apiKeySalt: autoBuyerKeys.apiKeySalt,
      apiKeyId: autoBuyerKeys.apiKeyId,
      status: 'active',
      createdAt: fixedNow,
      updatedAt: fixedNow,
    },
  ...
  const approvalBuyerAgent = await prisma.agent.create({
    data: {
      ...
      apiKeySalt: approvalBuyerKeys.apiKeySalt,
      apiKeyId: approvalBuyerKeys.apiKeyId,
      status: 'active',
      createdAt: fixedNow,
      updatedAt: fixedNow,
    },
